...
public class RemainsRenderer extends MobRenderer<RemainsEntity, RemainsModel<RemainsEntity>> {
	private static final ResourceLocation NORMAL_TEXTURE = ResourceLocation.fromNamespaceAndPath("creraces", "textures/entities/remains.png");
	private static final ResourceLocation UNDEAD_TEXTURE = ResourceLocation.fromNamespaceAndPath("creraces", "textures/entities/remains_undead.png");
