    ...
    public static void syncFromServer(Map<ResourceLocation, JsonElement> data) {
        ...
        resolvedData.forEach((id, jsonObject) -> {
            try {
                ...
                if (icon == null)
                    icon = ResourceLocation.fromNamespaceAndPath("minecraft", "textures/item/barrier.png");
                ...
                if (portrait == null)
                    portrait = ResourceLocation.fromNamespaceAndPath("creraces", "textures/screens/race.png");
                ...
                if (splash == null)
                    splash = ResourceLocation.fromNamespaceAndPath("creraces", "textures/screens/unknown_splash.png");
                ...
                if (bgTex == null)
                    bgTex = ResourceLocation.fromNamespaceAndPath("creraces", "textures/screens/selection_bg.png");
