...
/** Eterveil, a mystical spring liquid. Ambient sound/particles mirror vanilla WaterFluid's own animateTick. */
public abstract class EterveilFluid extends FlowingFluid {
    ...
    public boolean isSame(Fluid fluid) {
        return fluid == ModFluids.ETERVEIL.get() || fluid == ModFluids.ETERVEIL_FLOWING.get();
    }
