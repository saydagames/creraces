...
public class ScalingValue {
    ...
    private static Evaluator parseEvaluator(String statKey) {
        ...
        if (finalKey.equals("creraces:ap") || finalKey.equals("creraces:ability_power")) {
            return (s, p, t, sl, ip) -> {
                net.minecraft.core.Holder<Attribute> attr = ModAttributes.resolve(ModAttributes.ABILITY_POWER);
                return attr != null ? s.getAttributeValue(attr) : 0.0;
            };
        }
        if (finalKey.equals("creraces:ad") || finalKey.equals("creraces:attack_damage")) {
            return (s, p, t, sl, ip) -> {
                net.minecraft.core.Holder<Attribute> attr = ModAttributes.resolve(ModAttributes.ATTACK_DAMAGE);
                return attr != null ? s.getAttributeValue(attr) : 0.0;
            };
        }
        if (finalKey.equals("creraces:crit") || finalKey.equals("creraces:crit_rate")) {
            return (s, p, t, sl, ip) -> {
                net.minecraft.core.Holder<Attribute> attr = ModAttributes.resolve(ModAttributes.CRIT_RATE);
                if (attr == null)
                    return 0.0;
        ...
        if (finalKey.equals("creraces:ability_haste")) {
            return (s, p, t, sl, ip) -> {
                net.minecraft.core.Holder<Attribute> attr = ModAttributes.resolve(ModAttributes.ABILITY_HASTE);
                if (attr == null)
                    return 0.0;
                double val = s.getAttributeValue(attr);
                if (ModAttributes.isPercentAttribute(attr))
        ...
        if (finalKey.equals("creraces:armor_shred")) {
            return (s, p, t, sl, ip) -> {
                net.minecraft.core.Holder<Attribute> attr = ModAttributes.resolve(ModAttributes.ARMOR_SHRED);
                if (attr == null)
                    return 0.0;
                double val = s.getAttributeValue(attr);
                if (ModAttributes.isPercentAttribute(attr))
                ...
                if (effectId != null) {
                    return (s, p, t, sl, ip) -> {
                        net.minecraft.core.Holder<net.minecraft.world.effect.MobEffect> effect =
                                net.minecraft.core.registries.BuiltInRegistries.MOB_EFFECT.getHolder(effectId)
        ...
        return (s, p, t, sl, ip) -> {
            net.minecraft.core.Holder<Attribute> attr = BuiltInRegistries.ATTRIBUTE.getHolder(attrId)
                    .map(h -> (net.minecraft.core.Holder<Attribute>) h).orElse(null);
