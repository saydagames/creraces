...
public class FeatherProjectile extends ThrowableItemProjectile {
    ...
    protected void defineSynchedData(net.minecraft.network.syncher.SynchedEntityData.Builder builder) {
        ...
        builder.define(ITEM_STACK, new ItemStack(getDefaultItem()));
    }
    ...
    protected void onHitEntity(@Nonnull EntityHitResult result) {
        if (!this.level().isClientSide && result.getEntity() instanceof LivingEntity living) {
            ...
            var holder = registry.getHolderOrThrow(
                    ResourceKey.create(Registries.DAMAGE_TYPE, ResourceLocation.fromNamespaceAndPath("creraces", "feather")));
