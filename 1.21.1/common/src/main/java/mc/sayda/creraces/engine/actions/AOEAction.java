...
public class AOEAction implements ActionRegistry.RaceAction {
    ...
    private final net.minecraft.core.Holder<net.minecraft.world.effect.MobEffect> cachedRequired;
    private final net.minecraft.core.Holder<net.minecraft.world.effect.MobEffect> cachedNot;
    ...
    public AOEAction(mc.sayda.creraces.engine.ScalingValue radius, mc.sayda.creraces.engine.TargetFilter targets,
        ...
        this.cachedRequired = (requiredEffect != null && !requiredEffect.isEmpty())
                ? net.minecraft.core.registries.BuiltInRegistries.MOB_EFFECT
                        .getHolder(net.minecraft.resources.ResourceLocation.parse(requiredEffect))
        ...
        this.cachedNot = (notEffect != null && !notEffect.isEmpty())
                ? net.minecraft.core.registries.BuiltInRegistries.MOB_EFFECT
                        .getHolder(net.minecraft.resources.ResourceLocation.parse(notEffect))
                        .map(h -> (net.minecraft.core.Holder<net.minecraft.world.effect.MobEffect>) h).orElse(null)
                : null;
    }
