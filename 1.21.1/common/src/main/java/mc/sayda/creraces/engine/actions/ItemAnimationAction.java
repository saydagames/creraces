...
public class ItemAnimationAction implements ActionRegistry.RaceAction {
    public static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath("creraces", "item_animation");
    ...
    public static void register() {
        ActionRegistry.register(ID, json -> {
            ...
            ResourceLocation item = ResourceLocation.parse(itemStr);
