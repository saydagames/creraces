...
public static void init() {
        ...
        dev.architectury.event.events.common.EntityEvent.ADD.register((entity, level) -> {
            if (!level.isClientSide()
                    ...
                    && sl.dimension().location().equals(
                            net.minecraft.resources.ResourceLocation.fromNamespaceAndPath(CreRaces.MODID, "fairy_realm"))) {
                entity.discard();
    ...
    private static void onIncidentVictory(ServerPlayer killer, net.minecraft.world.entity.LivingEntity victim) {
        ...
        if (mc.sayda.creraces.config.CreRacesConfig.COIN_DROP_ENABLED.get()
            ...
            var taxingEnchant = mc.sayda.creraces.registry.ModEnchantments.get(killer.level(),
                    mc.sayda.creraces.registry.ModEnchantments.TAXING);
            ...
            for (ServerPlayer player : server.getPlayerList().getPlayers()) {
                DataUtils.getVariables(player).ifPresent(vars -> {
                    if (!vars.hasChosenRace()) {
                        net.minecraft.core.Holder<net.minecraft.world.effect.MobEffect> res = net.minecraft.world.effect.MobEffects.DAMAGE_RESISTANCE;
                        if (res != null) {
...
public static void onTrackingBegin(ServerPlayer tracker, net.minecraft.world.entity.Entity target) {
    ...
    public static void onRespawn(ServerPlayer player) {
        ...
        DataUtils.getVariables(player).ifPresent(vars -> {
            net.minecraft.core.Holder<net.minecraft.world.entity.ai.attributes.Attribute> maxMana = mc.sayda.creraces.registry.ModAttributes.MAX_MANA;
            net.minecraft.core.Holder<net.minecraft.world.entity.ai.attributes.Attribute> maxEnergy = mc.sayda.creraces.registry.ModAttributes.MAX_ENERGY;
