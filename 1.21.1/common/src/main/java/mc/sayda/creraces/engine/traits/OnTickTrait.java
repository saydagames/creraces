...
public class OnTickTrait extends PeriodicTrait {
    ...
    protected boolean shouldExecute(Player player, IPlayerVariables vars) {
        ...
        ResourceLocation failId = ResourceLocation.fromNamespaceAndPath(Objects.requireNonNull(traitId.getNamespace()),
    ...
    public static void register() {
        TraitRegistry.register(ResourceLocation.fromNamespaceAndPath(CreRaces.MODID, "on_tick"), json -> {
