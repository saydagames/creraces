...
public class BleedingEffect extends SimpleEffect {
    ...
    public boolean applyEffectTick(@javax.annotation.Nonnull LivingEntity entity, int amplifier) {
                    ...
                    if (uuidStr != null && !uuidStr.isEmpty()) {
                        ...
                        if (entity.level() instanceof ServerLevel serverLevel) {
                            ...
                            if (source instanceof LivingEntity livingSource) {
                                var apAttr = ModAttributes.resolve(ModAttributes.ABILITY_POWER);
        ...
        var resKey = ResourceKey.create(Registries.DAMAGE_TYPE, ResourceLocation.fromNamespaceAndPath("creraces", "bleeding"));
