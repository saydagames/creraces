...
public class ClaimTerritoryAction implements ActionRegistry.RaceAction {
    ...
    public static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath("creraces", "claim_territory");
    ...
    public static void register() {
        ActionRegistry.register(ID, json -> {
            ...
            ResourceLocation nodeX = json.has("node_x_state")
                    ? ResourceLocation.parse(json.get("node_x_state").getAsString())
                    : ResourceLocation.fromNamespaceAndPath("creraces", "node_x");
            ResourceLocation nodeY = json.has("node_y_state")
                    ? ResourceLocation.parse(json.get("node_y_state").getAsString())
                    : ResourceLocation.fromNamespaceAndPath("creraces", "node_y");
            ResourceLocation nodeZ = json.has("node_z_state")
                    ? ResourceLocation.parse(json.get("node_z_state").getAsString())
                    : ResourceLocation.fromNamespaceAndPath("creraces", "node_z");
