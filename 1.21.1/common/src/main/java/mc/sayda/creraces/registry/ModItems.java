...
public class ModItems {
        ...
        public static final RegistrySupplier<Item> BLUE_MERMAID_HELMET = ITEMS.register("blue_mermaid_helmet",
                        () -> new net.minecraft.world.item.ArmorItem(ModArmorMaterials.BLUE, net.minecraft.world.item.ArmorItem.Type.HELMET, new Item.Properties().durability(ModArmorMaterials.durabilityFor(net.minecraft.world.item.ArmorItem.Type.HELMET, ModArmorMaterials.BLUE_DURABILITY_MULTIPLIER))));
        public static final RegistrySupplier<Item> BLUE_MERMAID_CHESTPLATE = ITEMS.register("blue_mermaid_chestplate",
                        () -> new net.minecraft.world.item.ArmorItem(ModArmorMaterials.BLUE, net.minecraft.world.item.ArmorItem.Type.CHESTPLATE, new Item.Properties().durability(ModArmorMaterials.durabilityFor(net.minecraft.world.item.ArmorItem.Type.CHESTPLATE, ModArmorMaterials.BLUE_DURABILITY_MULTIPLIER))));
        public static final RegistrySupplier<Item> BLUE_MERMAID_LEGGINGS = ITEMS.register("blue_mermaid_leggings",
                        () -> new net.minecraft.world.item.ArmorItem(ModArmorMaterials.BLUE, net.minecraft.world.item.ArmorItem.Type.LEGGINGS, new Item.Properties().durability(ModArmorMaterials.durabilityFor(net.minecraft.world.item.ArmorItem.Type.LEGGINGS, ModArmorMaterials.BLUE_DURABILITY_MULTIPLIER))));
        public static final RegistrySupplier<Item> BLUE_MERMAID_BOOTS = ITEMS.register("blue_mermaid_boots",
                        () -> new net.minecraft.world.item.ArmorItem(ModArmorMaterials.BLUE, net.minecraft.world.item.ArmorItem.Type.BOOTS, new Item.Properties().durability(ModArmorMaterials.durabilityFor(net.minecraft.world.item.ArmorItem.Type.BOOTS, ModArmorMaterials.BLUE_DURABILITY_MULTIPLIER))));

        // Mermaid Armor - Green
        public static final RegistrySupplier<Item> GREEN_MERMAID_HELMET = ITEMS.register("green_mermaid_helmet",
                        () -> new net.minecraft.world.item.ArmorItem(ModArmorMaterials.GREEN, net.minecraft.world.item.ArmorItem.Type.HELMET, new Item.Properties().durability(ModArmorMaterials.durabilityFor(net.minecraft.world.item.ArmorItem.Type.HELMET, ModArmorMaterials.GREEN_DURABILITY_MULTIPLIER))));
        public static final RegistrySupplier<Item> GREEN_MERMAID_CHESTPLATE = ITEMS.register("green_mermaid_chestplate",
                        () -> new net.minecraft.world.item.ArmorItem(ModArmorMaterials.GREEN, net.minecraft.world.item.ArmorItem.Type.CHESTPLATE, new Item.Properties().durability(ModArmorMaterials.durabilityFor(net.minecraft.world.item.ArmorItem.Type.CHESTPLATE, ModArmorMaterials.GREEN_DURABILITY_MULTIPLIER))));
        public static final RegistrySupplier<Item> GREEN_MERMAID_LEGGINGS = ITEMS.register("green_mermaid_leggings",
                        () -> new net.minecraft.world.item.ArmorItem(ModArmorMaterials.GREEN, net.minecraft.world.item.ArmorItem.Type.LEGGINGS, new Item.Properties().durability(ModArmorMaterials.durabilityFor(net.minecraft.world.item.ArmorItem.Type.LEGGINGS, ModArmorMaterials.GREEN_DURABILITY_MULTIPLIER))));
        public static final RegistrySupplier<Item> GREEN_MERMAID_BOOTS = ITEMS.register("green_mermaid_boots",
                        () -> new net.minecraft.world.item.ArmorItem(ModArmorMaterials.GREEN, net.minecraft.world.item.ArmorItem.Type.BOOTS, new Item.Properties().durability(ModArmorMaterials.durabilityFor(net.minecraft.world.item.ArmorItem.Type.BOOTS, ModArmorMaterials.GREEN_DURABILITY_MULTIPLIER))));

        // Mermaid Armor - Yellow
        public static final RegistrySupplier<Item> YELLOW_MERMAID_HELMET = ITEMS.register("yellow_mermaid_helmet",
                        () -> new net.minecraft.world.item.ArmorItem(ModArmorMaterials.YELLOW, net.minecraft.world.item.ArmorItem.Type.HELMET, new Item.Properties().durability(ModArmorMaterials.durabilityFor(net.minecraft.world.item.ArmorItem.Type.HELMET, ModArmorMaterials.YELLOW_DURABILITY_MULTIPLIER))));
        public static final RegistrySupplier<Item> YELLOW_MERMAID_CHESTPLATE = ITEMS
                        .register("yellow_mermaid_chestplate",
                                        () -> new net.minecraft.world.item.ArmorItem(ModArmorMaterials.YELLOW, net.minecraft.world.item.ArmorItem.Type.CHESTPLATE, new Item.Properties().durability(ModArmorMaterials.durabilityFor(net.minecraft.world.item.ArmorItem.Type.CHESTPLATE, ModArmorMaterials.YELLOW_DURABILITY_MULTIPLIER))));
        public static final RegistrySupplier<Item> YELLOW_MERMAID_LEGGINGS = ITEMS.register("yellow_mermaid_leggings",
                        () -> new net.minecraft.world.item.ArmorItem(ModArmorMaterials.YELLOW, net.minecraft.world.item.ArmorItem.Type.LEGGINGS, new Item.Properties().durability(ModArmorMaterials.durabilityFor(net.minecraft.world.item.ArmorItem.Type.LEGGINGS, ModArmorMaterials.YELLOW_DURABILITY_MULTIPLIER))));
        public static final RegistrySupplier<Item> YELLOW_MERMAID_BOOTS = ITEMS.register("yellow_mermaid_boots",
                        () -> new net.minecraft.world.item.ArmorItem(ModArmorMaterials.YELLOW, net.minecraft.world.item.ArmorItem.Type.BOOTS, new Item.Properties().durability(ModArmorMaterials.durabilityFor(net.minecraft.world.item.ArmorItem.Type.BOOTS, ModArmorMaterials.YELLOW_DURABILITY_MULTIPLIER))));
        ...
        public static final RegistrySupplier<Item> LOFI_WARCRIMES_DISC = ITEMS.register("lofi_warcrimes_disc",
                        ...
                        new net.minecraft.world.item.Item.Properties().stacksTo(1)
                                ...
                                .jukeboxPlayable(net.minecraft.resources.ResourceKey.create(
                                        ...
                                        net.minecraft.resources.ResourceLocation.fromNamespaceAndPath("creraces", "lofi_warcrimes")))));
        public static final RegistrySupplier<Item> VERMINWAVE_DISC = ITEMS.register("verminwave_disc",
                        ...
                        new net.minecraft.world.item.Item.Properties().stacksTo(1)
                                ...
                                .jukeboxPlayable(net.minecraft.resources.ResourceKey.create(
                                        net.minecraft.core.registries.Registries.JUKEBOX_SONG,
                                        net.minecraft.resources.ResourceLocation.fromNamespaceAndPath("creraces", "verminwave")))));
        public static final RegistrySupplier<Item> UNDERGROUND_CLUB_DISC = ITEMS.register("underground_club_disc",
                        ...
                        new net.minecraft.world.item.Item.Properties().stacksTo(1)
                                ...
                                .jukeboxPlayable(net.minecraft.resources.ResourceKey.create(
                                        net.minecraft.core.registries.Registries.JUKEBOX_SONG,
                                        net.minecraft.resources.ResourceLocation.fromNamespaceAndPath("creraces", "underground_club")))));
        public static final RegistrySupplier<Item> PLEASANT_BOPS_DISC = ITEMS.register("pleasant_bops_disc",
                        ...
                        new net.minecraft.world.item.Item.Properties().stacksTo(1)
                                ...
                                .jukeboxPlayable(net.minecraft.resources.ResourceKey.create(
                                        net.minecraft.core.registries.Registries.JUKEBOX_SONG,
                                        net.minecraft.resources.ResourceLocation.fromNamespaceAndPath("creraces", "pleasant_bops")))));
