...
public class TornadoModel<T extends Entity> extends EntityModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath("creraces", "tornado"), "main");
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay,
            int color) {
        layer1.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
        layer2.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
        layer3.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
        layer4.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
        layer5.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
    }
}
