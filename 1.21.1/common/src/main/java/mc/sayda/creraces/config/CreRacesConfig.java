...
public class CreRacesConfig {
    ...
    // [SECTION: QUEST]
    /** If false (default), items credited toward a collect-item quest are removed from the
     *  player's inventory as they're tracked, instead of being left in place. */
    public static Supplier<Boolean> KEEP_QUEST_ITEMS = () -> false;
