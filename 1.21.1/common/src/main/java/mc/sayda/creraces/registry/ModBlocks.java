...
public class ModBlocks {
        ...
        public static final RegistrySupplier<Block> DRYAD_SIGN = BLOCKS.register("dryad_sign",
                        () -> new StandingSignBlock(mc.sayda.creraces.registry.ModWoodTypes.DRYAD, BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_GREEN).noCollission()
        ...
        public static final RegistrySupplier<Block> DRYAD_WALL_SIGN = BLOCKS.register("dryad_wall_sign",
                        () -> new WallSignBlock(mc.sayda.creraces.registry.ModWoodTypes.DRYAD, BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_GREEN).noCollission()
                                                        .strength(1.0F).sound(SoundType.WOOD)));
        public static final RegistrySupplier<Block> DRYAD_HANGING_SIGN = BLOCKS.register("dryad_hanging_sign",
                        () -> new CeilingHangingSignBlock(mc.sayda.creraces.registry.ModWoodTypes.DRYAD, BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_GREEN).noCollission()
        ...
        public static final RegistrySupplier<Block> DRYAD_WALL_HANGING_SIGN = BLOCKS.register("dryad_wall_hanging_sign",
                        () -> new WallHangingSignBlock(mc.sayda.creraces.registry.ModWoodTypes.DRYAD, BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_GREEN).noCollission()
                                                        .strength(1.0F).sound(SoundType.HANGING_SIGN)));
        ...
        public static final RegistrySupplier<Block> DRYAD_SAPLING = BLOCKS.register("dryad_sapling",
                        () -> new SaplingBlock(
                                        new net.minecraft.world.level.block.grower.TreeGrower("creraces_dryad",
                                                        java.util.Optional.empty(),
                                                        java.util.Optional.of(net.minecraft.resources.ResourceKey.create(
                                                                        net.minecraft.core.registries.Registries.CONFIGURED_FEATURE,
                                                                        net.minecraft.resources.ResourceLocation.fromNamespaceAndPath("creraces", "dryad_tree"))),
                                                        java.util.Optional.empty()),
        ...
        public static final RegistrySupplier<Block> DRYAD_FENCE_GATE = BLOCKS.register("dryad_fence_gate",
                        () -> new FenceGateBlock(net.minecraft.world.level.block.state.properties.WoodType.OAK, BlockBehaviour.Properties.ofFullCopy(DRYAD_PLANKS.get())));
        public static final RegistrySupplier<Block> DRYAD_BUTTON = BLOCKS.register("dryad_button",
                        () -> new ButtonBlock(net.minecraft.world.level.block.state.properties.BlockSetType.OAK, 30, BlockBehaviour.Properties.of().noCollission().strength(0.5f)
                                                        .pushReaction(PushReaction.DESTROY)));
        public static final RegistrySupplier<Block> DRYAD_PRESSURE_PLATE = BLOCKS.register("dryad_pressure_plate",
                        () -> new PressurePlateBlock(net.minecraft.world.level.block.state.properties.BlockSetType.OAK, BlockBehaviour.Properties.ofFullCopy(DRYAD_PLANKS.get())));
        public static final RegistrySupplier<Block> DRYAD_TRAPDOOR = BLOCKS.register("dryad_trapdoor",
                        () -> new TrapDoorBlock(net.minecraft.world.level.block.state.properties.BlockSetType.OAK, BlockBehaviour.Properties.ofFullCopy(DRYAD_PLANKS.get()).noOcclusion()));
        public static final RegistrySupplier<Block> DRYAD_DOOR = BLOCKS.register("dryad_door",
                        () -> new DoorBlock(net.minecraft.world.level.block.state.properties.BlockSetType.OAK, BlockBehaviour.Properties.ofFullCopy(DRYAD_PLANKS.get())));
        ...
        public static final RegistrySupplier<Block> VEIL_WILLOW_SIGN = BLOCKS.register("veil_willow_sign",
                        () -> new StandingSignBlock(mc.sayda.creraces.registry.ModWoodTypes.VEIL_WILLOW, BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_GRAY).noCollission()
                                                        .strength(1.0F).sound(SoundType.WOOD)));
        public static final RegistrySupplier<Block> VEIL_WILLOW_WALL_SIGN = BLOCKS.register("veil_willow_wall_sign",
                        () -> new WallSignBlock(mc.sayda.creraces.registry.ModWoodTypes.VEIL_WILLOW, BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_GRAY).noCollission()
                                                        .strength(1.0F).sound(SoundType.WOOD)));
        public static final RegistrySupplier<Block> VEIL_WILLOW_HANGING_SIGN = BLOCKS.register("veil_willow_hanging_sign",
                        () -> new CeilingHangingSignBlock(mc.sayda.creraces.registry.ModWoodTypes.VEIL_WILLOW, BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_GRAY).noCollission()
                                                        .strength(1.0F).sound(SoundType.HANGING_SIGN)));
        public static final RegistrySupplier<Block> VEIL_WILLOW_WALL_HANGING_SIGN = BLOCKS.register("veil_willow_wall_hanging_sign",
                        () -> new WallHangingSignBlock(mc.sayda.creraces.registry.ModWoodTypes.VEIL_WILLOW, BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_GRAY).noCollission()
                                                        .strength(1.0F).sound(SoundType.HANGING_SIGN)));
        ...
        public static final RegistrySupplier<Block> VEIL_WILLOW_FENCE_GATE = BLOCKS.register("veil_willow_fence_gate",
                        () -> new FenceGateBlock(net.minecraft.world.level.block.state.properties.WoodType.OAK, BlockBehaviour.Properties.ofFullCopy(VEIL_WILLOW_PLANKS.get())));
        ...
        public static final RegistrySupplier<Block> VEIL_WILLOW_PRESSURE_PLATE = BLOCKS.register(
                        ...
                        () -> new PressurePlateBlock(net.minecraft.world.level.block.state.properties.BlockSetType.OAK, BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_GRAY)
        ...
        public static final RegistrySupplier<Block> VEIL_WILLOW_TRAPDOOR = BLOCKS.register("veil_willow_trapdoor",
                        () -> new TrapDoorBlock(net.minecraft.world.level.block.state.properties.BlockSetType.OAK, BlockBehaviour.Properties.ofFullCopy(VEIL_WILLOW_PLANKS.get()).noOcclusion()));
        public static final RegistrySupplier<Block> VEIL_WILLOW_DOOR = BLOCKS.register("veil_willow_door",
                        () -> new DoorBlock(net.minecraft.world.level.block.state.properties.BlockSetType.OAK, BlockBehaviour.Properties.ofFullCopy(VEIL_WILLOW_PLANKS.get()).noOcclusion()));
        public static final RegistrySupplier<Block> VEIL_WILLOW_SAPLING = BLOCKS.register("veil_willow_sapling",
                        () -> new mc.sayda.creraces.block.VeilWillowSaplingBlock(
                                        new net.minecraft.world.level.block.grower.TreeGrower("creraces_veil_willow",
                                                        java.util.Optional.empty(),
                                                        java.util.Optional.of(net.minecraft.resources.ResourceKey.create(
                                                                        net.minecraft.core.registries.Registries.CONFIGURED_FEATURE,
                                                                        net.minecraft.resources.ResourceLocation.fromNamespaceAndPath("creraces", "veil_willow_tree"))),
                                                        java.util.Optional.empty()),
                                        BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_SAPLING)
        ...
        public static final RegistrySupplier<Block> VEIL_GRIT = BLOCKS.register("veil_grit",
                        () -> new net.minecraft.world.level.block.ColoredFallingBlock(new net.minecraft.util.ColorRGBA(14406560), BlockBehaviour.Properties.of().mapColor(MapColor.SAND)
