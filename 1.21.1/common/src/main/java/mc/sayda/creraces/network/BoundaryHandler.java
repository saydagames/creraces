...
public class BoundaryHandler {
     ...
     */
    private static net.minecraft.network.RegistryFriendlyByteBuf newBuf() {
        net.minecraft.world.level.Level level = mc.sayda.creraces.client.ClientAccess.getLevel();
    ...
    private static net.minecraft.network.RegistryFriendlyByteBuf newBuf(net.minecraft.core.RegistryAccess registries) {
        return new net.minecraft.network.RegistryFriendlyByteBuf(
                java.util.Objects.requireNonNull(Unpooled.buffer()), registries);
    }
    ...
    public static void sendSetRace(SetRacePacket pkt) {
        net.minecraft.network.RegistryFriendlyByteBuf buf = newBuf();
        pkt.encode(buf);
    ...
    private static void send(ServerPlayer player, net.minecraft.resources.ResourceLocation id,
            java.util.function.Consumer<net.minecraft.network.FriendlyByteBuf> encoder) {
        net.minecraft.network.RegistryFriendlyByteBuf buf = newBuf(player.registryAccess());
        encoder.accept(buf);
