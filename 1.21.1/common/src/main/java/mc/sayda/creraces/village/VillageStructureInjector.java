...
public final class VillageStructureInjector {
    ...
    private static final ResourceLocation GUILD_HUT = ResourceLocation.fromNamespaceAndPath("creraces", "guild_hut");
    ...
    private static void addPiece(Registry<StructureTemplatePool> poolRegistry,
        ...
        ResourceLocation poolId = ResourceLocation.fromNamespaceAndPath("minecraft", "village/" + biome + "/houses");
        ...
        Holder<StructureProcessorList> processor = processorRegistry.getHolderOrThrow(
                ResourceKey.create(Registries.PROCESSOR_LIST, ResourceLocation.parse(processorId)));
