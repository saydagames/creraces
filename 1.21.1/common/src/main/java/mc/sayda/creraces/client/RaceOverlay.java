...
public class RaceOverlay {
    ...
    private static final ResourceLocation UI_BG = ResourceLocation.fromNamespaceAndPath("creraces", "textures/screens/ui_bg.png");
    private static final ResourceLocation UI_BG2 = ResourceLocation.fromNamespaceAndPath("creraces", "textures/screens/ui_bg2.png");
    private static final ResourceLocation UI_FRAME = ResourceLocation.fromNamespaceAndPath("creraces", "textures/screens/ui.png");
    private static final ResourceLocation UI_LVL = ResourceLocation.fromNamespaceAndPath("creraces", "textures/screens/ui_lvl.png");
    private static final ResourceLocation UI_RDY = ResourceLocation.fromNamespaceAndPath("creraces", "textures/screens/ui_rdy.png");
    private static final ResourceLocation UI_FG_FRAME = ResourceLocation.fromNamespaceAndPath("creraces", "textures/screens/ui_fg.png");
    private static final ResourceLocation UI_FG_BG = ResourceLocation.fromNamespaceAndPath("creraces", "textures/screens/ui_fg_bg.png");
    private static final ResourceLocation UI_M = ResourceLocation.fromNamespaceAndPath("creraces", "textures/screens/ui_m.png");
    private static final ResourceLocation UI_R = ResourceLocation.fromNamespaceAndPath("creraces", "textures/screens/ui_r.png");
    private static final ResourceLocation UI_E = ResourceLocation.fromNamespaceAndPath("creraces", "textures/screens/ui_e.png");
    private static final ResourceLocation UI_G = ResourceLocation.fromNamespaceAndPath("creraces", "textures/screens/ui_g.png");
    ...
    public static void render(@Nonnull GuiGraphics graphics, float tickDelta) {
        ...
        DataUtils.getVariables(player).ifPresent(vars -> {
            ...
            double maxRes = player.getAttributeValue(ModAttributes.MAX_MANA);

            switch (race.resourceType()) {
                case RAGE:
                    resourceTex = UI_R;
                    currentRes = resourceValue(vars, ResourceType.RAGE);
                    maxRes = player.getAttributeValue(ModAttributes.MAX_RAGE);
                    break;
                case ENERGY:
                    resourceTex = UI_E;
                    currentRes = resourceValue(vars, ResourceType.ENERGY);
                    maxRes = player.getAttributeValue(ModAttributes.MAX_ENERGY);
                    break;
                case GRIT:
                    resourceTex = UI_G;
                    currentRes = resourceValue(vars, ResourceType.GRIT);
                    maxRes = player.getAttributeValue(ModAttributes.MAX_GRIT);
                    break;
                case MANA:
                default:
                    break;
