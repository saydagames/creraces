...
public class ScrollItem extends Item {
    ...
    @Override
    public void appendHoverText(ItemStack stack, net.minecraft.world.item.Item.TooltipContext level, List<Component> tooltipComponents,
            ...
            if (ability != null) {
                ...
                if (!allowed.isEmpty()) {
                    ...
                    for (int i = 0; i < allowed.size(); i++) {
                        ...
                        // Tooltips only ever build client-side, so the old isClientSide guard is
                        // just a "do we actually have a local player" check now.
                        if (mc.sayda.creraces.client.ClientAccess.getPlayer() != null) {
