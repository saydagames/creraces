...
public class RaceDetailsScreen extends Screen {
        ...
        @Nonnull
        private static final ResourceLocation SELECTION_TITLE = ResourceLocation.fromNamespaceAndPath("creraces",
        ...
        @Nonnull
        private static final ResourceLocation INFO_ICON = ResourceLocation.fromNamespaceAndPath("creraces", "textures/screens/info.png");

        @Nonnull
        private static final ResourceLocation REFRESH_ICON = ResourceLocation.fromNamespaceAndPath("creraces",
        ...
        @Nonnull
        private static final ResourceLocation MF_ICON = ResourceLocation.fromNamespaceAndPath("creraces", "textures/screens/mf.png");
        ...
        public void render(@Nonnull GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
                ...
                // 4. Difficulty
                ResourceLocation diffTex = ResourceLocation.fromNamespaceAndPath("creraces",
