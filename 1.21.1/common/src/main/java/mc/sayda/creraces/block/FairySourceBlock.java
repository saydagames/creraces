...
public class FairySourceBlock extends LiquidBlock {
    ...
    public void entityInside(BlockState state, Level level, BlockPos pos, Entity entity) {
        ...
        if (entity instanceof ItemEntity item && !item.isRemoved()) {
            ...
            Optional<net.minecraft.world.item.crafting.RecipeHolder<FairySourceRecipe>> recipe = level.getRecipeManager()
            ...
            if (recipe.isPresent()) {
                ItemStack result = recipe.get().value().craft(stack);
        ...
        if (entity instanceof LivingEntity living && entity.tickCount % 40 == 0) {
            ...
            living.removeEffect(ModMobEffects.BROKEN_WINGS);
        }
    }
}
