...
public class RaceRegistry {
    ...
    public static final ResourceLocation NONE = ResourceLocation.fromNamespaceAndPath("creraces", "none");
    // Lookup constant for harpy-specific checks elsewhere (e.g. FeatherProjectile).
    public static final ResourceLocation HARPY = ResourceLocation.fromNamespaceAndPath("creraces", "harpy");
