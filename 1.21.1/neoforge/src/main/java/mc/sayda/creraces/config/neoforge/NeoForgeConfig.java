package mc.sayda.creraces.config.neoforge;
...
@EventBusSubscriber(modid = mc.sayda.creraces.CreRaces.MODID, bus = EventBusSubscriber.Bus.MOD)
public class NeoForgeConfig {
        ...
        static {
                ...
                final Pair<Entities, ModConfigSpec> entitiesPair = new ModConfigSpec.Builder()
        ...
        public static class Common {
                public final ModConfigSpec.ConfigValue<String> wiki_base_url;
                public final ModConfigSpec.ConfigValue<String> wiki_api_base;
                public final ModConfigSpec.ConfigValue<String> wiki_page_path;
                public final ModConfigSpec.ConfigValue<String> wiki_ability_namespace;
                public final ModConfigSpec.ConfigValue<Boolean> disable_remote_docs;
                public final ModConfigSpec.ConfigValue<Integer> doc_fetch_timeout_seconds;
                public final ModConfigSpec.ConfigValue<String> doc_cache_dir;
                public final ModConfigSpec.ConfigValue<String> doc_cache_filename;
                public final ModConfigSpec.ConfigValue<String> developer_resource_path;

                public final ModConfigSpec.ConfigValue<Boolean> forced_selection;
                public final ModConfigSpec.ConfigValue<Double> ability_haste_cap;
                public final ModConfigSpec.ConfigValue<Double> racial_ad_multiplier;
                public final ModConfigSpec.ConfigValue<Long> resource_decay_grace_period;

                public final ModConfigSpec.ConfigValue<Boolean> coin_drop_enabled;
                public final ModConfigSpec.ConfigValue<Boolean> sag_wings;
                public final ModConfigSpec.ConfigValue<Boolean> gstate_enabled;
                public final ModConfigSpec.ConfigValue<Integer> ritual_mode;

                // Safety caps (-1 = disabled)
                public final ModConfigSpec.ConfigValue<Integer> aoe_max_radius;
                public final ModConfigSpec.ConfigValue<Integer> beam_max_length;
                public final ModConfigSpec.ConfigValue<Integer> break_blocks_max_radius;
                public final ModConfigSpec.ConfigValue<Double> remove_block_hardness_limit;
                public final ModConfigSpec.ConfigValue<Integer> customization_value_max_length;
                public final ModConfigSpec.ConfigValue<Integer> delay_action_max_ticks;
                public final ModConfigSpec.ConfigValue<Integer> entity_data_key_max_length;
                public final ModConfigSpec.ConfigValue<Integer> give_item_max_count;
                public final ModConfigSpec.ConfigValue<Integer> mass_summon_max_count;
                public final ModConfigSpec.ConfigValue<Integer> network_team_name_max_len;
                public final ModConfigSpec.ConfigValue<Integer> team_max_size;
                public final ModConfigSpec.ConfigValue<Integer> double_jump_cooldown_ticks;
                public final ModConfigSpec.ConfigValue<Integer> spirit_spawn_check_radius;
                public final ModConfigSpec.ConfigValue<Integer> max_rat_tunnels;

                public final ModConfigSpec.ConfigValue<Boolean> mini_build_enabled;
                public final ModConfigSpec.ConfigValue<Boolean> mini_furnace_enabled;
                public final ModConfigSpec.ConfigValue<Boolean> mini_campfire_enabled;
                public final ModConfigSpec.ConfigValue<Boolean> mini_brewing_stand_enabled;
                public final ModConfigSpec.ConfigValue<Boolean> mini_place_whitelist_enabled;
                public final ModConfigSpec.ConfigValue<Double> social_defense_range;
                public final ModConfigSpec.ConfigValue<Integer> micro_block_light_per_torch;
                public final ModConfigSpec.ConfigValue<Integer> micro_block_max_light;
                public final ModConfigSpec.ConfigValue<Boolean> mini_build_requires_learned;
                public final ModConfigSpec.ConfigValue<Double> mini_crafting_distance_sqr;
                public final ModConfigSpec.ConfigValue<Long> mini_placement_spam_threshold_ms;
                public final ModConfigSpec.ConfigValue<Double> mini_block_reach_margin;
                public final ModConfigSpec.ConfigValue<Boolean> mini_block_water_resistant;
                public final ModConfigSpec.ConfigValue<java.util.List<? extends String>> mini_build_dimension_blacklist;

                public final ModConfigSpec.ConfigValue<Integer> territory_default_claim_radius;
                public final ModConfigSpec.ConfigValue<Integer> territory_max_nodes_per_player;
                public final ModConfigSpec.ConfigValue<Boolean> territory_inter_race_blocking;
                public final ModConfigSpec.ConfigValue<Integer> territory_map_claim_max_distance;
                public final ModConfigSpec.ConfigValue<Integer> territory_claim_cost_per_chunk;
                public final ModConfigSpec.ConfigValue<Boolean> territory_entry_messages;

                public final ModConfigSpec.ConfigValue<Boolean> team_require_same_race;

                public final ModConfigSpec.ConfigValue<Double> default_max_mana;
                public final ModConfigSpec.ConfigValue<Double> default_max_energy;
                public final ModConfigSpec.ConfigValue<Double> default_max_rage;
                public final ModConfigSpec.ConfigValue<Double> default_max_grit;

                public final ModConfigSpec.ConfigValue<Integer> fairy_realm_border_size;
                public final ModConfigSpec.ConfigValue<Boolean> veilwood_forest_enabled;
                public final ModConfigSpec.ConfigValue<Boolean> essence_vortex_worldgen_enabled;
                public final ModConfigSpec.ConfigValue<Boolean> essence_vortex_conversion_enabled;
                public final ModConfigSpec.ConfigValue<Boolean> keep_quest_items;

                public final ModConfigSpec.ConfigValue<String> action_default_pocket_dim;
                public final ModConfigSpec.ConfigValue<String> action_default_pocket_structure;
                public final ModConfigSpec.ConfigValue<Double> action_default_pocket_spawn_x_offset;
                public final ModConfigSpec.ConfigValue<Double> action_default_pocket_spawn_y_offset;
                public final ModConfigSpec.ConfigValue<Double> action_default_pocket_spawn_z_offset;
                public final ModConfigSpec.ConfigValue<Double> pocket_dim_spacing;
                public final ModConfigSpec.ConfigValue<Double> pocket_dim_y;
                public final ModConfigSpec.ConfigValue<Integer> pocket_expansion_limit;
                public final ModConfigSpec.ConfigValue<Double> pocket_expansion_cost;
                public final ModConfigSpec.ConfigValue<Integer> pocket_invite_max;
                public final ModConfigSpec.ConfigValue<Double> pocket_boundary;

                // Technical/Internal
                public final ModConfigSpec.ConfigValue<Boolean> race_addons_enabled;
                public final ModConfigSpec.ConfigValue<Boolean> lore_addons_enabled;

                public final ModConfigSpec.ConfigValue<Integer> passive_execution_interval;
                public final ModConfigSpec.ConfigValue<Double> sunlight_equipment_break_chance;
                public final ModConfigSpec.ConfigValue<Integer> sunlight_burn_seconds;
                public final ModConfigSpec.ConfigValue<Integer> passive_effect_buffer_ticks;
                public final ModConfigSpec.ConfigValue<Integer> passive_default_max_food;
                public final ModConfigSpec.ConfigValue<Double> passive_default_max_saturation;
                public final ModConfigSpec.ConfigValue<Double> max_soul;

                public final ModConfigSpec.ConfigValue<Double> rat_venom_scaling;
                public final ModConfigSpec.ConfigValue<Double> boiling_scaling;
                public final ModConfigSpec.ConfigValue<Double> bleeding_scaling;
        ...
        public static class Client {
                public final ModConfigSpec.ConfigValue<Integer> mini_model_cache_size;
                public final ModConfigSpec.ConfigValue<Integer> visual_sync_distance;
                public final ModConfigSpec.ConfigValue<Integer> race_overlay_offset_x;
                public final ModConfigSpec.ConfigValue<Integer> race_overlay_offset_y;
                public final ModConfigSpec.ConfigValue<Boolean> race_overlays_enabled;
                public final ModConfigSpec.ConfigValue<Boolean> engine_popups_enabled;
                public final ModConfigSpec.ConfigValue<Integer> mini_dummy_cache_size;
                public final ModConfigSpec.ConfigValue<Integer> hud_anchor_x;
                public final ModConfigSpec.ConfigValue<Integer> hud_anchor_y;
                public final ModConfigSpec.ConfigValue<Integer> hud_portrait_x;
                public final ModConfigSpec.ConfigValue<Integer> hud_portrait_y;
                public final ModConfigSpec.ConfigValue<Integer> hud_abilities_x;
                public final ModConfigSpec.ConfigValue<Integer> hud_abilities_y;
                public final ModConfigSpec.ConfigValue<Integer> hud_bars_x;
                public final ModConfigSpec.ConfigValue<Integer> hud_bars_y;
                public final ModConfigSpec.ConfigValue<String> bar_label_mode;
                public final ModConfigSpec.ConfigValue<Boolean> bar_show_seconds;
                public final ModConfigSpec.ConfigValue<Boolean> hud_bars_grow_up;
                public final ModConfigSpec.ConfigValue<Boolean> hud_abilities_vertical;
                public final ModConfigSpec.ConfigValue<String> hud_slot_label_side;
        ...
        public static class Entities {
                ...
                public final ModConfigSpec.DoubleValue troll_pillar_health;
                public final ModConfigSpec.DoubleValue troll_pillar_armor;
                public final ModConfigSpec.DoubleValue troll_pillar_follow_range;
                public final ModConfigSpec.DoubleValue troll_pillar_knockback_res;
                public final ModConfigSpec.DoubleValue poison_emitter_health;
                public final ModConfigSpec.DoubleValue poison_emitter_armor;
                public final ModConfigSpec.DoubleValue poison_emitter_follow_range;
                public final ModConfigSpec.DoubleValue poison_emitter_knockback_res;
                public final ModConfigSpec.DoubleValue tornado_health;
                public final ModConfigSpec.DoubleValue tornado_follow_range;

                public final ModConfigSpec.IntValue remains_decay_time;
                public final ModConfigSpec.DoubleValue remains_health;

                public final ModConfigSpec.IntValue troll_pillar_pulse_interval;
                public final ModConfigSpec.DoubleValue troll_pillar_curse_radius;
                public final ModConfigSpec.IntValue troll_pillar_curse_duration;
                public final ModConfigSpec.IntValue troll_pillar_lifetime_ticks;

                public final ModConfigSpec.DoubleValue tornado_armor;
                public final ModConfigSpec.DoubleValue tornado_attack_damage;
                public final ModConfigSpec.DoubleValue tornado_flying_speed;
                public final ModConfigSpec.DoubleValue tornado_movement_speed;
                public final ModConfigSpec.DoubleValue tornado_hurricane_radius;
                public final ModConfigSpec.IntValue tornado_dizziness_duration;
                public final ModConfigSpec.DoubleValue tornado_pull_force;
                public final ModConfigSpec.IntValue tornado_lifetime_ticks;

                public final ModConfigSpec.DoubleValue poison_emitter_mobile_max_health;
                public final ModConfigSpec.DoubleValue poison_emitter_mobile_movement_speed;
                public final ModConfigSpec.DoubleValue poison_emitter_radius;
                public final ModConfigSpec.IntValue poison_emitter_lifetime_ticks;

                public final ModConfigSpec.DoubleValue feather_damage;
                public final ModConfigSpec.DoubleValue feather_gravity;
        ...
        public static void apply(Object spec) {
                ...
                CreRacesConfig.HUD_CONFIG_SAVE = NeoForgeConfig::saveClientHudConfig;
                } // end CLIENT
