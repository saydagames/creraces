...
public class OnDeathTrait implements TraitRegistry.RaceTrait {
    ...
    public OnDeathTrait(List<ActionRegistry.RaceAction> actions, Condition condition) {
    ...
    public static void register() {
        TraitRegistry.register(new ResourceLocation(CreRaces.MODID, "on_death"), json -> {
            ...
            return new OnDeathTrait(actions, condition);
        });
    }
}
