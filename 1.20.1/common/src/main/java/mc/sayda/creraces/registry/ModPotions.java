...
public class ModPotions {
    ...
    public static final RegistrySupplier<Potion> REVEALING = POTIONS.register("revealing",
            () -> new Potion("creraces.revealing", new MobEffectInstance(ModMobEffects.REVEALING.get(), 1)));

    public static final RegistrySupplier<Potion> BANISHMENT = POTIONS.register("banishment",
            () -> new Potion("creraces.banishment", new MobEffectInstance(ModMobEffects.BANISHMENT.get(), 1)));
