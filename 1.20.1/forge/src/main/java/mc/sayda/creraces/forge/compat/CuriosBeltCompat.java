 ...
 * from CreRacesForge's beltFinder lambda would throw NoClassDefFoundError as soon as the lambda ran
 * on a Curios-less install, since nothing else in that class forced Curios to be a hard dependency.
 */
